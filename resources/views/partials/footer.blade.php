    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-2 max-w-sm">Your trusted partner for quality products and exceptional service.</p>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li class="mb-4"><a href="#" class="hover:underline">Shipping Info</a></li>
                        <li class="mb-4"><a href="#" class="hover:underline">Returns</a></li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Your Store™</a>. All Rights Reserved.</span>
